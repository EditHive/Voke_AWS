...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-950 transition-colors duration-300">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden bg-gradient-to-br from-violet-50 via-purple-50 to-fuchsia-50 dark:from-gray-900 dark:via-purple-950/20 dark:to-fuchsia-950/20 pt-16 transition-colors duration-300">
        ...
        <div className="container mx-auto px-4 py-24 md:py-32 relative z-10">
          <div className="max-w-4xl mx-auto text-center">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-violet-100 dark:bg-violet-950/50 text-violet-700 dark:text-violet-300 text-sm font-medium mb-6 transition-colors duration-300">
              <Sparkles className="w-4 h-4" />
              AI-Powered Interview Preparation
            </div>
            <h1 className="text-5xl md:text-7xl font-bold mb-6 bg-gradient-to-r from-violet-600 via-purple-600 to-fuchsia-600 dark:from-violet-400 dark:via-purple-400 dark:to-fuchsia-400 bg-clip-text text-transparent leading-tight">
              Elevate Your Interview Skills with AI
            </h1>
            <p className="text-xl md:text-xl mb-10 text-gray-600 dark:text-gray-400 leading-relaxed transition-colors duration-300">
              The complete AI toolkit to ace interviews and land your dream role. Practice with AI-powered interviews, get instVokeedback, and track your progress.
            </p>
      ...
      <section className="py-24 bg-gradient-to-br from-violet-50 via-purple-50 to-fuchsia-50 dark:from-gray-900 dark:via-purple-950/20 dark:to-fuchsia-950/20 transition-colors duration-300">
        <div className="container mx-auto px-4">
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-5xl font-bold mb-4 text-gray-900 dark:text-gray-100 transition-colors duration-300">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            {[
              ...
              <Card
                key={index}
                className="p-8 hover:shadow-2xl hover:shadow-violet-500/20 transition-all duration-300 border border-gray-100 dark:border-gray-800 bg-white dark:bg-gray-900 rounded-2xl cursor-pointer group hover:-translate-y-2 relative overflow-hidden"
                onClick={() => handleNavigate("/learning-paths")}
              >
                ...
                <ul className="space-y-4 relative z-10">
                  {profile.skills.map((skill, i) => (
                    <li key={i} className="flex items-center gap-3 text-gray-700 dark:text-gray-300 transition-colors duration-300 group-hover:translate-x-1 transition-transform">
        ...
        <div className="container mx-auto px-4">
          <Card className="bg-gradient-to-br from-violet-600 via-purple-600 to-fuchsia-600 dark:from-violet-700 dark:via-purple-700 dark:to-fuchsia-700 text-white p-16 text-center border-0 rounded-3xl shadow-2xl shadow-violet-500/30 dark:shadow-violet-500/20 relative overflow-hidden">
            ...
            <div className="relative z-10">
              ...
              <Button
                size="lg"
                className="bg-white dark:bg-gray-100 text-violet-700 dark:text-violet-800 hover:bg-gray-100 dark:hover:bg-gray-200 px-10 py-6 text-lg rounded-xl shadow-xl font-semibold transition-all duration-300"
                onClick={() => handleNavigate("/auth")}
              >
                Get Started Now
                <ArrowRight className="ml-2 w-5 h-5" />
